    ...
    <S.Container>
      ...
      <S.Body>
          ...
          <S.BodyListCard>
            <S.Card>
              <S.CardContent>
                ...
                <S.CardText>
                  O Centro Audiovisual do Pr desenvolve projetos voltados para educação audiovisual, seja na realização de<br />
                  oficinas de criação e produção em si, como também na produção de conteúdo de entreterimento com forte<br />
        ...
        <S.Faixa>
          ...
          <S.FaixaText>
            O CAP funciona como um laboratório de novas ideias digitais, e oferece “HackAthon Digital”, que são eventos, que estimulam<br />
            a criação de novos conteúdos e produtos a partir de desafios de produção, onde profissionais, aspirantes e estudantes do<br />
            mercado tem oportunidade de transformar ideias de projetos de filmes, séries, games, em vídeo pilotos, com o objetivo de<br />
